...
#### What authentication methods should be allowed for human users? (`human_auth_methods`: multi-select)
**What is this asking?**
Define how human users should authenticate to Snowflake.

**Why does this matter?**
This determines the security posture for your human user population. Stronger authentication reduces the risk of unauthorized access.

**Options explained:**
- **SAML Only (SSO required)**: Users must authenticate through your IdP. Most secure option. Requires SSO to be fully operational.
- **SAML or Password with MFA**: Users can use SSO or password + MFA. Provides flexibility during SSO rollout.
- **Password with MFA Only**: Users authenticate with username/password plus MFA. Use if you don't have SSO configured.

**Recommendation:**
- If you configured SAML: **SAML Only** for maximum security
- During SSO rollout: **SAML or Password with MFA** for flexibility
- If you skipped SAML configuration: **Password with MFA Only** (only option available)
